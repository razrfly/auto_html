...
AutoHtml.add_filter(:soundcloud).with(:width => '100%', :height => 300, :auto_play => false, :theme_color => '00FF00', :color => 'f6382d', :show_comments => false, :show_artwork => true) do |text, options|
  require 'uri'
  require 'net/http'
